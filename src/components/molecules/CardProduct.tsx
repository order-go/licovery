...
const ProductDetail=({product,onAddToCart}: {product: Product,onAddToCart: () => void}) => {
    return (
        <div className=" shadow-[0px_2px_25px_0px_#f7fafc] flex flex-col justify-between items-center w-72 h-auto p-5 border-2 border-primary text-white rounded-lg">
            <div>
